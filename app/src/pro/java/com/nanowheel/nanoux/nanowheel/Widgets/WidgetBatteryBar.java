...
public class WidgetBatteryBar extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {//remove true to launch app on click for older versions without .startForegroundService
            ...
            if (backC == 4){
                views.setOnClickPendingIntent(R.id.batteryTextW, getPendingSelfIntent(context, OnClick));
                views.setOnClickPendingIntent(R.id.batteryBarW, getPendingSelfIntent(context, OnClick));
            }
        }else {
            ...
            if (backC == 4){
                views.setOnClickPendingIntent(R.id.batteryTextW, pendingIntent);
                views.setOnClickPendingIntent(R.id.batteryBarW, pendingIntent);
            }
        }
