...
public class Battery {
    ...
    // State Variables
    private int    owPercent = 0;
    private int    owRemaining = 0;
    private int    cellCount = 16;
    private double fmLimitPercent = FM_LIMIT_PERCENT;
    private double txExtraPercent = TX_EXTRA_PERCENT;
    private double batteryTemp = 30;
    private double medianOutput = LiFePO4_16_OUTPUT;
    private double medianCells = LiFePO4_16_CELLS;
    private double avgVoltsOut = -1.0;
    private double avgVoltsCells = -1.0;
    private double avgRemainOut = 0.0;
    private double avgRemainCells = 0.0;
    private double ampAdjust = 0.0;
    private double idleAdjust = 0.0;
    private double tempCurveRatio = 1.0;

    private double ampsRemainBase = -1.0;
    private double ampsRemainStart = -1.0;
    private double ampsUsedStart = -1.0;
    private double ampsRegenStart = -1.0;
    private double ampsUsed = -1.0;
    private double ampsRegen = -1.0;
    private double ampsConvert = 0.0;
    private int    ampsRemaining = 0;


    public void resetStateTwoX() {
        ampsRemainBase = -1.0;
        ampsRemainStart = -1.0;
        ampsUsedStart = -1.0;
        ampsRegenStart = -1.0;
    ...
    public void saveStateTwoX(SharedPreferencesUtil prefs) {
        Date date = new Date();
        String jsonString;
    ...
    public void initStateTwoX(SharedPreferencesUtil prefs) {
        Date date = new Date();
    ...
    private double adjustVolts(double volts, double median, double smooth) {
        double scale;
    ...
    private double calcRemain(double curve, double median, double volts) {
    ...
    private double convertRatioTwoX(double percent) {
        return( percent*fmLimitPercent/100 );
    }

    public int getRemainingDefault() {
        return(owPercent);
    }

    public int getRemainingOW() {
        return(owRemaining);
    }

    public int getRemainingAmps() {
    ...
    public boolean setAmps(double amps) {
        ampAdjust = amps;

        return(false);
    }

    public boolean setSpeedRpm(int rpms) {
        if (rpms<MOVING_RPMS) {
            idleAdjust = -0.2;
        } else {
            idleAdjust = 0;
    ...
    public boolean setBatteryTemp(int temp) {
        double percent = 0;
    ...
    public boolean setUsedAmpHrs(double amphrs) {
    ...
    public boolean setRegenAmpHrs(double amphrs) {
        ampsRegen = amphrs;
    ...
    public boolean setRemaining(int level) {
    ...
    public boolean setOutput(double volts) {
    ...
    public boolean setCells(double volts) {
