...
public class BluetoothUtilImpl implements BluetoothUtil{
    ...
    private int connectionMode = 0; //0 = original, 1 = + & XR, 2 = pint
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic c, int status) {
            ...
            if (characteristic_uuid.equals(OWDevice.OnewheelCharacteristicFirmwareRevision)) {
                ...
                if(version >= 4034 && version < 5000) {
                    ...
                    byte[] plzwrk = Util.StringToByteArrayFastest("098e56c8c595bc9423ce87aea3bc3a45738c4278");
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic c) {
            ...
            //if (c.getUuid().toString().equals(OWDevice.OnewheelCharacteristicUartSerialRead)){
                //testy do
            //}
            if (c.getUuid().toString().equals(OWDevice.OnewheelCharacteristicUartSerialRead) && connectionMode == 1) {
        ...
        public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
            ...
            if (connectionMode == 1 && descriptor.getCharacteristic().getUuid().toString().equals(OWDevice.OnewheelCharacteristicUartSerialRead)){
    ...
    private void whenActuallyConnected(){
        mOWDevice.battery.initStateTwoX(SharedPreferencesUtil.getPrefs(application));
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic bluetoothGattCharacteristic) {
        ...
        while (!success) {
            success = mGatt.writeCharacteristic(bluetoothGattCharacteristic);
        }
    }
